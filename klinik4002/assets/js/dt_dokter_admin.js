$(document).ready(function(){
  ...
  table = $('#table_dokter').DataTable({
      ...
      "ajax": {
          "url": "http://localhost/klinik4002/admin/dokter/data_dokter",
          "type": "POST",
          "dataType": "JSON"
      },
   ...
   $('#daftar_dokter').on('click', function(){
    ...
    $.ajax({
      url: "http://localhost/klinik4002/admin/dokter/buat_dokter",
      type: "GET",
      dataType: "JSON",
  ...
  $('tbody').on('click', 'edit_dokter', function(){
    ...
    $.ajax({
      url: "http://localhost/klinik4002/admin/dokter/edit_dokter/" + id_dokter,
      type: "GET",
      dataType: "JSON",
      success: function(data){
        $('[name="id_dokter"]').val(data.id_dokter);
  ...
  $('tbody').on('click', '#hapus_dokter', function(){
    ...
    if (confirm('Apakah Anda yakin ingin menghapus dokter?')){
      $.ajax({
        url: "http://localhost/klinik4002/admin/dokter/hapus_dokter/" + id_dokter,
        type: "POST",
 ...
 //ON CLICK BUTTON SIMPAN (MODAL)
  $('#btn_simpan').on('click', function(){
    ...
    if (aksi == 'add') {
      ...
      url = "http://localhost/klinik4002/admin/dokter/edit_dokter";
    }
