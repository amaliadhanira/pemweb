...
class M_Antrean_Saya extends CI_Model{

	var $column_order = array(null, 'nama_dokter', 'nama_spesialisasi', 'tgl_periksa', null);
	var $column_search = array('nama_dokter', 'nama_spesialisasi', 'tgl_periksa');
	var $order = array('tgl_periksa' => 'asc');
	var $table = 'antrean';
	...
	private function _get_datatables_query(){
		...
		$this->get_my_antrean($this->session->username);
