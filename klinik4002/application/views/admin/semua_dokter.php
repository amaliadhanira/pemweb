...
<head>
    ...
    <title>Dashboard | Klinik Tong Pang</title>
                                                                        ...
                                                                        <li>
                                                                            <div class="">
                                                                                <div class="">
                                                                                    ...
                                                                                    <div class="">
                                                                                        <div class="">
                                                                                            <input type="" name="" checked="" class="" id="">
                                                                                            <label class="" for="">
																									<span class=""></span>
																									<span class=""></span>
																								</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            <li><a>Data Dokter</a> <span class="bread-slash"></span>
                                            </li>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="hpanel hblue contact-panel contact-panel-cs responsive-mg-b-30">
                            <div class="panel-body custom-panel-jw">
                                ...
                                <h3><a href="">Hanujikun</a></h3>
                                <p class="all-pro-ad">Dokter Gigi</p>
                                <p>
                                    Sudah sangat berpengalaman dalam bidang ini.
                                </p>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="hpanel hblue contact-panel contact-panel-cs responsive-mg-b-30">
                            <div class="panel-body custom-panel-jw">
                                ...
                                <h3><a href="">Reydhan</a></h3>
                                <p class="all-pro-ad">Dokter Umum</p>
                                <p>
                                   Sudah sangat berpengalaman dalam bidang ini.
                                </p>
                            </div>
